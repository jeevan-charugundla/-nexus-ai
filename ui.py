...
class HudCanvas(QWidget):
    def __init__(self, face_path: str, assistant_name: str = "Nexus AI", parent=None):
    ...
    def paintEvent(self, _):
        ...
        # Top HUD brackets text: ┌── NEXUS AI CORE ONLINE ──┐
        p.setPen(QPen(qcol(C.PRI, 220), 1))
        p.setFont(QFont("Courier New", 8, QFont.Weight.Bold))
        p.drawText(QRectF(0, max(4.0, cy - fw * 0.44), W, 20.0), Qt.AlignmentFlag.AlignCenter, "┌── NEXUS AI CORE ONLINE ──┐")
...
class LogWidget(QTextEdit):
    ...
    def __init__(self, parent=None):
        ...
        self._pos     = 0
        self._tag     = "sys"
        self._ai_name_lc = "nexus ai"   # updated when assistant name changes
        self._tmr = QTimer(self)
        self._tmr.timeout.connect(self._step)
    ...
    def _next(self):
        ...
        elif tl.startswith(_ai_pfx) or tl.startswith("nexus:") or tl.startswith("nexus ai:") or tl.startswith("jarvis:"): self._tag = "ai"
...
class FileDropZone(QWidget):
    ...
    def _browse(self):
        path, _ = QFileDialog.getOpenFileName(
            self, "Select a file for Nexus AI", str(Path.home()),
            "All Files (*.*);;"
...
class SetupOverlay(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        layout.addWidget(_lbl("Configure Nexus AI before first boot.", 9, color=C.PRI_DIM))
        layout.addSpacing(6)
...
class CustomizeOverlay(QWidget):
    ...
    def __init__(self, assistant_name="Nexus AI", user_name="",
    ...
    def _save(self):
        name = self._name_input.text().strip() or "Nexus AI"
...
class AudioDeviceOverlay(_HudOverlay):
    """Choose which microphone Nexus AI listens to and which speakers it uses.
    ...
    is plugged in. 'NEXUS can't hear me' is usually 'NEXUS is listening to the
    webcam'."""
    ...
    def __init__(self, parent=None):
        ...
        self._in_box  = _row("MICROPHONE — what Nexus AI hears you with",
                             "input", get_input_device())
        lay.addSpacing(4)
        self._out_box = _row("SPEAKERS — what Nexus AI talks through",
...
class MemoryOverlay(_HudOverlay):
    """Everything Nexus AI has stored about you, and when it learned it.
    ...
    def _rebuild(self):
        ...
        hdr = QLabel("🧠  WHAT NEXUS AI REMEMBERS")
        hdr.setFont(QFont("Courier New", 12, QFont.Weight.Bold))
        hdr.setStyleSheet(f"color: {C.PRI}; background: transparent;")
...
class ClipboardPanel(QWidget):
    """Floating panel shown when text is copied — offers quick Nexus AI actions."""
...
class RemoteKeyOverlay(QWidget):
    ...
    def mark_connected(self) -> None:
        ...
        self._timer_lbl.setText("Phone connected — Nexus AI ready")
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        ...
        self._assistant_name: str = (_cfg.get("assistant_name") or "Nexus AI").strip()
        ...
        self.on_interrupt      = None   # callable: () -> None — stop Nexus AI mid-speech
    ...
    def _create_lnk_windows(lnk: str, target: str, args: str,
        ...
        try:
            ...
            sc.Description      = "Nexus AI Assistant"
        ...
        try:
            ...
            # ── macOS — proper .app bundle (no Terminal window) ───────────────
                ...
                (app / "Contents" / "Info.plist").write_text(
                    ...
                    '  <key>CFBundleExecutable</key><string>Nexus AI</string>\n'
                    '  <key>CFBundleIdentifier</key>'
                    '<string>com.jarvis.assistant</string>\n'
                    '  <key>CFBundleName</key><string>Nexus AI</string>\n'
    ...
    def _build_header(self) -> QWidget:
        ...
        self._title_lbl = QLabel("NEXUS AI")
    ...
    def _build_right_panel(self) -> QWidget:
        ...
        log_hdr = QLabel("📜 SYSTEM LOG // NEXUS AI")
    ...
    def _open_customize(self):
        ...
        cw = self.centralWidget()
        ov = CustomizeOverlay(
            cfg.get("assistant_name", "Nexus AI") or "Nexus AI",
            cfg.get("user_name", ""),
    ...
    def _apply_name_update(self, name: str, user_name: str, ui_color: str = "",
                           voice: str = ""):
        self._assistant_name = name.strip() or "Nexus AI"
        display = self._assistant_name.upper()
        self.setWindowTitle(f"{display} - {APP_VERSION}")
        self._title_lbl.setText(display)
        if display.upper() in ("JARVIS", "J.A.R.V.I.S", "NEXUS", "NEXUS AI", "NEXUS.AI"):
    ...
    def _on_setup_done(self, key: str, os_name: str):
        ...
        if self._overlay:
            ...
            self._overlay = None
        self._apply_state("LISTENING")
        self._assistant_name = _read_full_config().get("assistant_name", "Nexus AI") or "Nexus AI"
