...
def get_assistant_name() -> str:
    """Return the configured assistant name, or 'Nexus AI' if not set."""
    return load_api_keys().get("assistant_name", "Nexus AI") or "Nexus AI"
...
def save_assistant_config(assistant_name: str, user_name: str) -> None:
    ...
    if CONFIG_FILE.exists():
        try:
            ...
            data = {}
    data["assistant_name"] = assistant_name.strip() or "Nexus AI"
...
def get_wake_word_enabled() -> bool:
    """Whether local wake-word gating is on (assistant sleeps until wake word)."""
